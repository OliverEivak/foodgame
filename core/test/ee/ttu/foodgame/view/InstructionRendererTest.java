...
public class InstructionRendererTest {
    ...
    public void setup() {
        ...
        // TestSubject
        InstructionRenderer = new InstructionRenderer(stage, game);
    ...
    public void resize() {
        ...
        InstructionRenderer.resize(width, height);
    ...
    public void render() {
        ...
        InstructionRenderer.render(delta);
