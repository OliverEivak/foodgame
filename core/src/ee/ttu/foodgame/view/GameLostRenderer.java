...
public class GameLostRenderer implements View {
    ...
    public GameLostRenderer(Stage stage, int score) {
        ...
        loseLabel.setPosition(GAME_WIDTH * 0.35f, GAME_HEIGHT * 0.7f);
